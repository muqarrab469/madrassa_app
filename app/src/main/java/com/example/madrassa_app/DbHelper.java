...
public class DbHelper  extends SQLiteOpenHelper{
        ...
        public void insertStudent(Student student) {
            ...
            values.put(COLUMN_CLASS, student.getClass1());
        ...
        public void updateStudent(Student student) {
            ...
            db.update(TABLE_NAME, values, COLUMN_CLASS + " = ?", new String[] {student.getClass1()});
            db.close();
        }
        ...
        * */
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    students.add(new Student(name, class1,age));
